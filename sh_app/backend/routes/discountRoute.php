<?php
    ...
    switch ($accion) {
        case 'insertar':
            if (isset($_POST['nombre']) && isset($_POST['descuento']) && isset($_POST['descripcion']) && isset($_POST['fecha_inicial']) && isset($_POST['fecha_final'])) {
                $nombre = $_POST['nombre'];
                ...
                $respuesta = insertar($conn, $nombre, $descuento, $descripcion, $fecha_inicial, $fecha_final);
        ...
        case 'actualizar':
            if (isset($_POST['id']) && isset($_POST['nombre']) && isset($_POST['descuento']) && isset($_POST['descripcion']) && isset($_POST['fecha_inicial']) && isset($_POST['fecha_final'])) {
                $id = $_POST['id'];
                $nombre = $_POST['nombre'];
                $descuento = $_POST['descuento'];
                $descripcion = $_POST['descripcion'];
                ...
                $respuesta = actualizar($conn, $id, $nombre, $descuento, $descripcion, $fecha_inicial, $fecha_final);
                echo json_encode($respuesta);
            } else {
